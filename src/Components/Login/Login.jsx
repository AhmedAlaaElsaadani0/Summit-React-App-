        ...
        <form action="">
          ...
          <div className="modal-body">
            ...
            <div className="mb-3 d-flex justify-content-between">
              ...
              <input className="form-check-input mx-2"  type="checkbox" value="" id="remember" required/>
          ...
          <div className="modal-footer pt-4">                  
            <button type="button" className="btn btn-success mx-auto w-100">{t("Login")}</button>
          </div>
