...
useEffect(() => {
  ...
  return (
    ...
    <Helmet>
      ...
      <a href='https://wa.me/message/T4HZAXRBWHYTP1?src=qr' target='_blank'  className={` position-fixed   d-flex WhatsappSocial  justify-content-center align-items-center mb-3 bottom-0  ${ flagDirection?" me-3 end-0  " : " ms-3 start-0 "}`}>
        <div
          className={
            `bg-primColor text-white mb-5 WhatsappText shadow rounded-5 text-center rounded-3 p-2  
            ${flagDirection ? 'me-2':'ms-2'}`}
            style={{          right: !flagDirection?"auto":"100%",
