                ...
                <div className="row">
                    <div className={`col-md-8 fs-3 fw-bolder AbartmentDesc ${this.props.flag ? 'text-white' : 'text-primColor'}`}>
                        <div className="fs-3 px-3 fw-bolder w-100">
                            <h2 className="py-2">      <span class="placeholder col-7"></span>  </h2>
                            <h2 className="py-2"> <span class="placeholder col-10"></span></h2>
                            <div className={`text-black fs-4 p-4 ${this.props.flag ? 'text-white' : 'text-black'}`}>
                                <p id="Floor">
                                    Floor :  <span class="placeholder col-4"></span>
                                </p>
                                <p id="Price">
                                    Price :  <span class="placeholder col-5"></span>
                                </p>
                                <p id="Apartmentn">
                                    Apartmentn:  <span class="placeholder col-6"></span>
                                </p>
                                <p id="Descripition">
